...
var Timepicker = function (_React$Component) {
    ...
    _createClass(Timepicker, [{
        ...
        value: function render() {
            ...
            var others = _objectWithoutProperties(_props, ['className', 'inputOpts']);

            var classes = (0, _classnames2.default)(_defineProperty({
                'lib-pc-timepicker-lib-timepicker': true
            }, className, className));

            var containerClass = (0, _classnames2.default)((_classNames2 = {
                'container': true
            }, _defineProperty(_classNames2, this.state.position, true), _defineProperty(_classNames2, 'show', this.state.show), _defineProperty(_classNames2, 'hide', !this.state.show), _classNames2));
